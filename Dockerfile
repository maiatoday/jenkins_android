...
# Android config
RUN curl -L https://raw.github.com/embarkmobile/android-sdk-installer/version-2/android-sdk-installer | bash /dev/stdin --install=tools,platform-tools,build-tools-23.0.1,android-23,extra-android-support,extra-android-m2repository,extra-google-m2repository --dir=/opt --accept="android-sdk-license-5be876d5|android-sdk-preview-license-52d11cd2"
